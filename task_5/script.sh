...
# Install utils.
BASE_DIR='/root'
yum install -y vim redhat-lsb-core wget rpmdevtools rpm-build createrepo yum-utils
...
# Change spec.
sed -i '116i --with-openssl='$BASE_DIR/openssl-1.1.1g' \\' $BASE_DIR/rpmbuild/SPECS/nginx.spec
# Build rpm package.
